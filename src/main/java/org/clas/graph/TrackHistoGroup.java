...
public class TrackHistoGroup extends HistoGroup{
    ...
    public void addTrackDiffHistos(int color, int startOrder){
        ...
        h1_p_diff = new H1F("pDiff", "Diff. of p", 100, -0.3, 0.3);
